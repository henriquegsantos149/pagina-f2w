  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 pointer-events-none">
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="pointer-events-auto flex items-center gap-3 bg-brand-gradient text-[var(--color-brand-dark)] px-4 py-3 md:px-6 md:py-4 shape-leaf shadow-[0_10px_30px_rgba(109,166,155,0.4)] group relative overflow-hidden cursor-pointer border-none"
      >
